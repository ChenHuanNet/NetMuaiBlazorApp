...
namespace ArmyFlag.Platforms.Android
{
    /// <summary>
    /// 浏览器权限对接安卓权限
    ...
    internal class PermissionManagingBlazorWebChromeClient : WebChromeClient, IActivityResultCallback
    {
        ...
        public override bool OnJsBeforeUnload(global::Android.Webkit.WebView view, string? url, string? message, JsResult? result)
        ...
        public override void OnReceivedIcon(global::Android.Webkit.WebView view, Bitmap? icon)
            => _blazorWebChromeClient.OnReceivedIcon(view, icon);
        public override void OnReceivedTitle(global::Android.Webkit.WebView view, string? title)
            => _blazorWebChromeClient.OnReceivedTitle(view, title);
        public override void OnReceivedTouchIconUrl(global::Android.Webkit.WebView view, string? url, bool precomposed)
            => _blazorWebChromeClient.OnReceivedTouchIconUrl(view, url, precomposed);
        public override void OnRequestFocus(global::Android.Webkit.WebView view)
